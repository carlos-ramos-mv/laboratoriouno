...
<div class="container-fluid">
    <div class="row">
        <div class=""><h1 class="">Editar curso <strong>{{$curso->nombre}}</strong></h1></div>
        <div class="container">
            <div class="mt-3 bg-white p-3">
                <form class="needs-validation" novalidate method="POST" action="{{route('admin.cursos.update',$curso->id)}}">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input id="nombre" name="nombre" class="form-control" type="text" placeholder="Escriba el nombre" value="{{$curso->nombre}}" required>

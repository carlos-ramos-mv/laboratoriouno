...
CREATE TABLE "public"."modulos" (
  ...
  "updated_at" timestamp(0),
  "curso_id" int8 NOT NULL,
  "breve_descripcion" varchar(255) COLLATE "pg_catalog"."default",
  "status" bool
)
;
...
SELECT setval('"public"."cursos_id_seq"', 33, true);
...
SELECT setval('"public"."feedbacks_id_seq"', 2, false);
...
SELECT setval('"public"."modulos_id_seq"', 21, true);
...
SELECT setval('"public"."rates_id_seq"', 2, false);
...
SELECT setval('"public"."temas_id_seq"', 13, true);
...
-- ----------------------------
ALTER TABLE "public"."avances" ADD CONSTRAINT "avances_pkey" PRIMARY KEY ("user_id", "avanzable_id", "avanzable_type");
...
-- ----------------------------
ALTER TABLE "public"."rates" ADD CONSTRAINT "id" UNIQUE ("id");

-- ----------------------------
-- Primary Key structure for table rates
-- ----------------------------
ALTER TABLE "public"."rates" ADD CONSTRAINT "rates_pkey" PRIMARY KEY ("user_id", "rateable_id", "rateable_type");
...
-- ----------------------------
ALTER TABLE "public"."feedbacks" ADD CONSTRAINT "fk_feedbacks_rates_1" FOREIGN KEY ("rate_id") REFERENCES "public"."rates" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
